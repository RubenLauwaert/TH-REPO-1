import { CredentialSet, ResourceIdentifier, getLoggerFor, ResourceSet, 
    ForbiddenHttpError, NotFoundHttpError, UnauthorizedHttpError, 
    AuthorizerInput, Authorizer, PermissionSet, AccessMode} from '@solid/community-server';
 ...
 */
export class MacaroonBasedAuthorizer extends Authorizer {
